    ...
    <div className="page policy-page">
      ...
      <section>
        ...
        <ul>
          ...
          <li>Invoices are due within 30 days unless otherwise stated. Late payments may incur finance charges (1.5% per
            month or the maximum permitted by law) and suspension of the Services.</li>
      ...
      <section>
        ...
        <ul>
          ...
          <li>EXCEPT AS EXPRESSLY PROVIDED, THE SERVICES ARE PROVIDED “AS IS” AND “AS AVAILABLE.” RETURN SHIELD DISCLAIMS ALL IMPLIED WARRANTIES, INCLUDING MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.</li>
      ...
      <section>
        ...
        <p>
          ...
          EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. RETURN SHIELD’S TOTAL LIABILITY FOR ALL CLAIMS IN ANY 12
